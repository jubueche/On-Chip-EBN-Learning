...
file_name = "sim1_plot.png"
data_path = os.path.join(base_path, "Simulation 1/")
sim_prefix = "Sim1_"
...
rect = patches.Rectangle((t_start,7),0.075,3,linewidth=0.5,edgecolor='grey',facecolor='none')
